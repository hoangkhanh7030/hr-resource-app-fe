...
import { WORKSPACES_URL, DASHBOARD_URL, DAYOFF_URL } from "constants/index";
...
export const deleteBookingDayOffService = (id, bookingId) => {
  return axios
    .delete(
      `${process.env.REACT_APP_API_URL}${WORKSPACES_URL}/${DAYOFF_URL}/${bookingId}`,
      {
        headers: authHeader(),
      }
    )
